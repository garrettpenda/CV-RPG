...
setInterval(function() {
	...
	if(String(window["MAP" + carte.numero + "F"][joueur.posy][joueur.posx]).length==10 && joueur.immobil){
		...
		//window["MAP" + carte.numero + "F"][joueur.posy][joueur.posx]=1;
	}
		
	document.getElementById("demo").innerHTML = " X : " + joueur.posx + " Y : " + joueur.posy + "<br>" +  "case X : " + Math.floor( joueur.posx/32) + " case Y : " + Math.floor( joueur.posy/32)+ "<br>" ;
