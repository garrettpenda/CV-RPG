...
setInterval(function() {
	...
	if(String(window["MAP" + carte.numero + "F"][joueur.posy][joueur.posx]).length==10 && joueur.immobil){
	...
	document.getElementById("demo").innerHTML = " X : " + Math.floor(joueur.posx) + " Y : " + Math.floor(joueur.posy)+joueur.canmove;
...
window.onkeydown = function(event) {
	...
	switch(key) {
		...
		case 40 : case 115 : case 83 : // Flèche bas, s, S
			joueur.deplacer(DIRECTION.BAS,carte,joueur);
			break;
			
		case 37 : case 113 : case 97 : case 81 : case 65 : // Flèche gauche, q, a, Q, A
			joueur.deplacer(DIRECTION.GAUCHE,carte,joueur);
			break;
			
		case 39 : case 100 : case 68 : // Flèche droite, d, D
			joueur.deplacer(DIRECTION.DROITE,carte,joueur);
			break;
			
		case 38 : case 122 : case 119 : case 90 : case 87 : // Flèche haut, z, w, Z, W
			joueur.deplacer(DIRECTION.HAUT,carte,joueur);
			break;
